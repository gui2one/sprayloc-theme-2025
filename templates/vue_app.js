...
<div id="folders-bar">
    ...
    methods: {
      setCategory: function (category_name, event) {
        ...
        if (category_name === "all") {
          console.log("ALLLLL !!!!!!");
          window.location.href = `/materiels?category=all&page_num=${1}`;
          // this.$router.push({
          //   path: "/materiels",
          //   query: { page_num: 1 },
          // });
        } else {
          window.location.href = `/materiels?category=${category_name}&page_num=${1}`;
          // this.$router.push({
          //   path: "/materiels",
          //   query: {
  ...
  const Card = Vue.component("sprayloc-card", {
    ...
    methods: {
      showDetails: function (item_id) {
        window.location.href = "materiel?id=" + item_id;
        // this.$emit("show-details", item_id);
        // this.$router.push({
        //   path: "/",
        //   query: {
  ...
  var app = new Vue({
    ...
    methods: {
      ...
      computeFinalData() {
        ...
        vm.equipment.sort(function (a, b) {
